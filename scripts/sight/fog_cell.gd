...
## whether this forms the world boundary, in which case obstructs will always be true
var bounding: bool

## whether this cell blocks vision
var obstructs: bool = false

## The list of edges that this cell belongs to, used in LOS algorithm
